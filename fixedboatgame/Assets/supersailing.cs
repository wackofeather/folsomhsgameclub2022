            ...
            if (rotationstate == 1) // 1 is right, -1 is left
            {
                if (easeangle > -10)
                {
                    ...
                    if (isrotating == 1)
                    {
                        ...
                        {
                            gameObject.transform.localRotation = Quaternion.RotateTowards(gameObject.transform.localRotation, Quaternion.Euler(0, 0, 0), 20f * Time.deltaTime); //use huh somehow .....
                                                                                                                                                                 //huhh += 0.1f;
                        }
