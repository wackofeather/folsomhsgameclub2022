...
public class windtest : MonoBehaviour
{
    ...
    void Update()
    {
         inboss = distanceislander.GetComponent<islandfollowattempt2>().inboss;
         beforeboss = distanceislander.GetComponent<islandfollowattempt2>().beforeboss;
         afterboss = distanceislander.GetComponent<islandfollowattempt2>().afterboss;
