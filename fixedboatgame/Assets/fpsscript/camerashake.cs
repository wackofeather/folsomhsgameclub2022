...
public class camerashake : MonoBehaviour
{
    ...
    private Vector3 _orignalPosOfCam;
    ...
    {
        shaking = true;
        StartCoroutine(CameraShake(gameObject.transform.localPosition));
        Invoke("StopShake", duration);
    }
    IEnumerator CameraShake(Vector3 _orignalPosOfCam)
    {
        ...
        gameObject.transform.localPosition = _orignalPosOfCam;
        StopCoroutine(CameraShake(cameraTransform.position));
        yield return null;
    }
